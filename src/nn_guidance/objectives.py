...
def ic2mean_safety(
    ...
    Args:
        ...
        sfmap (torch.Tensor): safety map, [[x, y, safety], ...]], shape (n, 3)
        border_sharpness (float, optional): sharpness of reachable set border. Defaults to None.
...
def reachable_sfmap_hard(
    ...
    Returns:
        sfmap_reachable_idx (torch.Tensor): safety map indices of reachable set, shape (n, )
    """
